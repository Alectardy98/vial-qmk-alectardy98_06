...
//Caps Lock does Not currently sinc lock light status over bluetooth
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
      case CAPS: //notice how it skips over F22
        if (record->event.pressed) {
        SEND_STRING(SS_DOWN(X_F24)SS_TAP(X_CAPS));
          caps_tracker++;
            uint8_t ps2_led = 0;
               ps2_led |= (1<<PS2_LED_CAPS_LOCK);
            ps2_host_set_led(ps2_led);
...
void post_process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    case CAPS: // break custom caps lock leds
      if (!record->event.pressed) {
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
         KC_ESC,    TASK,                                                                                                                                         KC_PSCR, KC_SLCK, KC_PAUS,                                          \
           GOGL,     CMD,       KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSPC,       KC_INS, KC_HOME, KC_PGUP,     TG(_NUM), KC_PSLS, KC_PAST, KC_PMNS, \
        DM_PLY1, DM_PLY2,       KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC,  KC_ENT,       KC_DEL,  KC_END, KC_PGDN,      KC_HOME,   KC_UP, KC_PGUP, KC_PPLS, \
           SNIP,    EXPL,      KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,                                                        KC_LEFT, _______, KC_RGHT, KC_PEQL, \
           COPY,    PAST,      KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, KC_BSLS,                          KC_UP,               KC_END, KC_DOWN, KC_PGDN, KC_PENT, \
           VDLT,    VDRT,      MO(_FN),          KC_LALT,                             KC_SPC,                            KC_RALT,          KC_RCTL,               KC_LEFT, KC_DOWN, KC_RGHT,               KC_INS,  KC_DEL           \
    ),
    [_NUM] = LAYOUT(
        ...
        _______, _______,      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                                                           KC_4,    KC_5,    KC_6, _______, \
    ...
    [_FN] = LAYOUT(
        ...
        OUT_USB,  OUT_BT,      _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL,      _______, _______, _______,      _______, _______, _______, _______, \
        ...
        _______, _______,      KC_LCTL, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU,                                                           VDLT,    QUIT,    VDRT, _______, \
        _______, _______,      _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______,                           VDUP,               _______,    VDDN, _______, _______, \
        _______, _______,      _______,          KC_LGUI,                            _______,                            _______,          _______,                  VDLT,    VDDN,    VDRT,               _______, _______           \
    )
};
