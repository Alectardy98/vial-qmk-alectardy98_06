...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = LAYOUT(
     KC_ESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSLS,  KC_DEL,    SNIP,      KC_INS, KC_HOME, KC_PGUP,     KC_NLCK, KC_PSLS, KC_PAST, KC_PEQL,  \
    ...
    KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,  KC_GRV,  KC_ENT,             PAST,     KC_MPRV, KC_MPLY, KC_MNXT,        KC_1,    KC_5,    KC_6, KC_PMNS,  \
