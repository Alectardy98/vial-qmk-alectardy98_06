...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        MO(_FN), KC_LALT,                                      KC_SPC,                                     KC_RALT, KC_RCTL,               KC_LEFT, KC_DOWN, KC_RGHT,     KC_INS,  KC_DEL
    ),
    [_NUM] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,                        _______,                KC_1,    KC_2,    KC_3, _______,
    ...
    [_FN] = LAYOUT(
        ...
        _______, KC_LGUI,                                     _______,                                     _______, _______,                  VDLT,    VDDN,    VDRT,    _______,  _______
    ),
};
