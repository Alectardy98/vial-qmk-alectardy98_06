...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        RESET,     DEBUG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______, _______,    _______, _______, _______, _______, \
        ...
        _______, KC_LCTL,    CTLA,    CTLS,    CTLD,    CTLF, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______, _______,       VDLT,    QUIT,    VDRT, _______, \
        _______, _______,    CTLZ,    CTLX,    CTLC,    CTLV, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______,    VDUP, _______,    _______,    VDDN, _______, _______, \
