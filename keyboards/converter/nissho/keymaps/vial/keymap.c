...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
         ...
         KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,   KC_RO,                                                    KC_P4,   KC_P5,   KC_P6,          \
         KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,   KC_RO, KC_RSFT,                                KC_UP,              KC_P1,   KC_P2,   KC_P3, KC_PENT, \
         KC_LCTL, MO(_FN), KC_LALT,                    KC_SPC,                            KC_RALT, KC_RGUI, KC_KANA, KC_RCTL,                     KC_LEFT, KC_DOWN, KC_RGHT,     KC_P0, KC_PDOT
    ),
    [_NUM] = LAYOUT(
