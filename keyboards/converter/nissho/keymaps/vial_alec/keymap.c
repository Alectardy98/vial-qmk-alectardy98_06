...
void led_set(uint8_t usb_led)                                  //Custom Locklight override
{
    ...
    if (layer_state_is(_NUM)){                                 //When in layer _NUM, this will activate Num lock light
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
          ...
          KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSPC, KC_BSPC,    KC_INS, KC_HOME, KC_PGUP,  TG(_NUM), KC_PSLS, KC_PAST, KC_PMNS, \
         ...
         KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, KC_BSLS,                                                  KC_LEFT, _______, KC_RGHT,          \
         KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_BSLS, KC_RSFT,                                KC_UP,             KC_END, KC_DOWN, KC_RGHT, KC_PENT, \
         KC_LCTL, MO(_FN), KC_LALT,                    KC_SPC,                            MO(_FN), KC_RALT, KC_RGUI, KC_RCTL,                     KC_LEFT, KC_DOWN, KC_RGHT,    KC_INS,  KC_DEL
    ),
    [_NUM] = LAYOUT(
         ...
         _______, _______, _______,                   _______,                            _______, _______, _______, _______,                     _______, _______, _______,      KC_0,  KC_DOT
    ),
    [_FN] = LAYOUT(
           RESET,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______,                                       \
         _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL, _______,   _______, _______, _______,   _______, _______, _______, _______, \
         _______,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______, _______,            _______, _______, _______,   _______,    VDUP, _______, _______, \
         KC_LCTL, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______,                                                     VDLT,    QUIT,    VDRT,          \
         _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______,                                 VDUP,            _______,    VDDN, _______, _______, \
         _______, KC_LGUI, _______,                   _______,                            _______, _______, _______, _______,                        VDLT,    VDDN,    VDRT,   _______, _______
    ),};
