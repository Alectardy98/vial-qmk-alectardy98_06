...
void led_set(uint8_t usb_led) {                          //Lock Light LED Overide
    if (usb_led &  (1<<USB_LED_CAPS_LOCK)) {             //LED 3 on when in host capslock
        writePinLow(GP16);                               //LED 3 is GP22
    } else {
        writePinHigh(GP16);
    }
    if (layer_state_is(_FN)) {                           //LED 5, LED 6, LED 7 on when In layer FN
        writePinLow(GP29);                               //LED 5 is GP26
    } else {
        writePinHigh(GP29);
    } 
}
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
    TG(_FN), _______,     _______, _______, _______, _______, \
     KC_ESC,    TASK,       KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,                                                  _______, _______,  KC_INS,  KC_DEL, KC_INS,  KC_DEL, KC_LBRC, KC_RBRC, \
       GOGL,     CMD,      KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSPC,      KC_INS, KC_HOME, KC_PGUP,     KC_PEQL, KC_PSLS, KC_PAST,     KC_PMNS, \
    DM_PLY1, DM_PLY2,      KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC,  KC_ENT,      KC_DEL,  KC_END, KC_PGDN,       KC_P7,   KC_P8,   KC_P9,     KC_PPLS, \
       SNIP,    EXPL,     KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, KC_BSLS,              KC_MPRV, KC_MPLY, KC_MNXT,       KC_P4,   KC_P5,   KC_P6,     KC_BSPC, \
       COPY,    PAST,     KC_LSFT, KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, MO(_FN),     KC_VOLD,   KC_UP, KC_VOLU,       KC_P1,   KC_P2,   KC_P3,     KC_PENT, \
       VDLT,    VDRT,     KC_LCTL, MO(_FN),                                      KC_SPC,                                              KC_RALT, KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT,       KC_P0,   KC_P0, KC_PDOT),             \
    
    [_FN] = LAYOUT(
    QK_BOOT, _______,     _______, _______, _______, _______,
    QK_BOOT,   DEBUG,     _______, _______, _______, _______, _______, _______, _______, _______, _______,                                                 _______, _______, _______, _______, _______, _______, _______, _______, \
    ...
    _______, _______,     KC_LCTL, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______,             _______, _______, _______,        VDLT,    QUIT,    VDRT,      _______, \
    ...
    _______, _______,     KC_LGUI, _______,                                     _______,                                              _______, _______,       VDLT,    VDDN,    VDRT,     _______, _______, _______),
};
