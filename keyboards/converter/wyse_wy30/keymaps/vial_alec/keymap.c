...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
             KC_ESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSPC, KC_BSPC,        SNIP,    EXPL,    COPY,    PAST, \
             KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC,  KC_GRV,  KC_DEL,        KC_7,    KC_8,    KC_9, KC_PMNS, \
            KC_LCTL,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,  KC_ENT,  DM_PLY1,                KC_4,    KC_5,    KC_6, KC_COMM, \
            KC_LALT, KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,            KC_UP, DM_PLY2,        KC_1,    KC_2,    KC_3, KC_PENT, \
            MO(_FN),                                               KC_SPC,                                     KC_BSLS, KC_LEFT, KC_DOWN, KC_RGHT,                 KC_0,  KC_DOT           \
            ),
    [_FN] = LAYOUT(
            ...
            _______,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______, _______, _______,     _______,    VDUP, _______, _______, \
            _______, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, DM_REC1,                 VDLT,    QUIT,    VDRT, _______, \
            KC_LGUI, _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY,             VDUP, DM_REC2,     _______,    VDDN, _______, _______, \
            _______,                                              _______,                                     _______,    VDLT,    VDDN,    VDRT,              _______, _______           \
            ),
} ;
