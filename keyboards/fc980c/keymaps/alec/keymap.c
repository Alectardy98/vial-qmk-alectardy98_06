...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_BASE] = LAYOUT(
         KC_ESC,            KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,        COPY,    PAST,    SNIP,    EXPL,
        ...
        KC_LCTL, MO(_FN), KC_LALT,                    KC_SPC,                   KC_RALT, KC_LGUI, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT,       KC_P0, KC_PDOT),
    ...
    [_FN] = LAYOUT(
        ...
        _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL,     _______, _______, _______, _______,
        _______,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______, _______,     _______,    VDUP, _______, _______,
        KC_LCTL,    CTLA,    CTLS,    CTLD,    CTLF, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______,                 VDLT,    QUIT,    VDRT,
        _______,    CTLZ,    CTLX,    CTLC,    CTLV, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,             VDUP,     _______,    VDDN, _______, _______,
        KC_LGUI, _______, _______,                   _______,                   _______, _______, _______,             VDLT,    VDDN,    VDRT,     _______, _______),
};
