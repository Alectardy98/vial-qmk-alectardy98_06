...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_BASE] = LAYOUT(
         KC_ESC,            KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,        SNIP,    EXPL,    COPY,    PAST,
        ...
        KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,            KC_UP,        KC_1,    KC_2,    KC_3, KC_PENT,
        KC_LCTL, MO(_FN), KC_LALT,                    KC_SPC,                   KC_RALT, KC_LGUI, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT,        KC_0, KC_PDOT),
