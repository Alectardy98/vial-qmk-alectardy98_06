...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  DM_PLY1, DM_PLY2,    KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS,  KC_DEL,
     ...
     VDLT,    VDRT,   KC_LCTL, MO(_FN), KC_LGUI, KC_LALT,  KC_SPC, _______,           KC_SPC, _______, KC_RALT, KC_RGUI, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
  ),

  [_FN] = LAYOUT_all(
    QK_GESC,          QK_BOOT, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, _______, _______, _______, _______,
    ...
    _______, _______, _______, _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______, _______,
    _______, _______, KC_LGUI, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______
  )
