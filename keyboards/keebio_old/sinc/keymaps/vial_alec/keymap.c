...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_80_with_macro(
    RGB_TOG,  KC_ESC,       KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,           KC_F13, KC_MPLY,
    ...
    DM_PLY1, DM_PLY2,      KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS,           KC_DEL,
       SNIP,    EXPL,     KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,           KC_ENT,          KC_PGUP,
       COPY,    PAST,     KC_LSFT,             KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,   KC_UP,          KC_PGDN,
       VDLT,    VDRT,     KC_LCTL, KC_LGUI, MO(_FN), KC_LALT,  KC_SPC,  KC_SPC, _______,  KC_SPC, KC_RALT, KC_RCTL, KC_RGUI,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    
  [_FN] = LAYOUT_80_with_macro(
    _______,   RESET,     RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, _______, _______,          _______, _______,
    ...
    _______, _______,     KC_LCTL,    CTLA,    CTLS,    CTLD,    CTLF, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU,          _______,          _______,
    _______, _______,     _______,             CTLZ,    CTLX,    CTLC,    CTLV, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,    VDUP,          _______,
