...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base */
    [_BASE] = LAYOUT_all(
    RESET,            KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9, KC_F10,   KC_F11,  KC_F12,              KC_MPRV,  KC_MPLY, KC_MNXT,
    ...
    [_FN] = LAYOUT_all(
        ...
        KC_LGUI, _______, _______, _______,                            HPT_TOG,                   _______, _______, _______, _______,                  VDLT,    VDDN,    VDRT
    )
};
