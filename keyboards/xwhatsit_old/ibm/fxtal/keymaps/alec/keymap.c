...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_all(
        ...
        DM_PLY1, DM_PLY2,     KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS,    KC_7,    KC_8,    KC_9,  KC_PPLS,
           SNIP,    EXPL,    KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, _______,  KC_ENT,    KC_4,    KC_5,    KC_6,  KC_PEQL,
           COPY,    PAST,    KC_LSFT, _______,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,   KC_UP,    KC_1,    KC_2,    KC_3,  KC_BSPC,
           VDLT,    VDRT,   KC_LCTRL, MO(_FN), KC_LALT,                   KC_BSPC, _______,  KC_SPC,                   KC_RALT, KC_RCTRL,KC_LEFT, KC_DOWN, KC_RGHT,    KC_0, KC_PDOT,  KC_PENT
    ),
    [_NUM] = LAYOUT_all(
    ...
    [_FN] = LAYOUT_all(
        ...
        _______, _______,    KC_LCTL,    CTLA,    CTLS,    CTLD,    CTLF, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______,    VDLT,    QUIT,    VDRT, _______,
        _______, _______,    _______, _______,    CTLZ,    CTLX,    CTLC,    CTLV, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,    VDUP, _______,    VDDN, _______, _______,
