...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, LT(_HHKB,KC_BSLS),  KC_ENT,
  KC_LSFT, _______,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,
  KC_LCTL, MO(_FN), KC_LALT,                             KC_SPC,                                     KC_RALT, KC_LGUI, KC_RCTRL),
  ...
  KC_LCTL, KC_VOLU, KC_VOLD, KC_MPLY, KC_EJCT, _______, KC_PAST, KC_PSLS, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, KC_PPLS, KC_PMNS,  KC_END, KC_PGDN, KC_DOWN, _______,
  ...
  _______, _______,    VDUP,    VDUP, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  KC_LCTL, _______,    VDLT,    VDRT, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______,
  _______, _______, _______,    VDDN, _______, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,
  KC_LGUI, _______, _______,                            _______,                                     _______, _______, _______),
};
