...
[_BASE] = LAYOUT(
  ...
  KC_LSFT, _______,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, LT(_HHKB,KC_BSLS),
  _______, KC_LCTL, MO(_FN),                             KC_SPC,                            KC_RALT, KC_RCTL, KC_LGUI, _______),
  
[_FN] = LAYOUT(
   KC_ESC, _______, _______, _______, _______, _______, _______,    KC_7,    KC_8,    KC_9, _______, KC_PMNS, KC_PPLS, _______, KC_DEL,
  _______, _______, _______, _______,    VDUP, _______, _______,    KC_4,    KC_5,    KC_6,    SNIP,    COPY,    PAST, _______,
  KC_LCTL, _______, _______,    VDLT,    VDRT, _______, _______,    KC_1,    KC_2,    KC_3, KC_VOLD, KC_VOLU, _______, _______,
  _______, _______, _______, _______,    VDDN, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, KC_BSLS,
...
[_HHKB] = LAYOUT(
  ...
  KC_LCTL, KC_VOLU, KC_VOLD, KC_MPLY, KC_EJCT, _______, KC_PAST, KC_PSLS, KC_HOME, KC_PGUP, KC_LEFT, KC_RIGHT, _______, _______,
