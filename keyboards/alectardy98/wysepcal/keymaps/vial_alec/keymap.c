...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
       QUIT,    TASK,      KC_ESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSPC,    MO(_NUM), _______, KC_SLCK, _______, \
    DM_PLY1, DM_PLY2,      KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC,  KC_GRV,     KC_HOME,   KC_UP, KC_PGUP, KC_PMNS, \
       SNIP,    EXPL,     KC_LCTL,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,  KC_ENT,              KC_LEFT, _______, KC_RGHT, _______, \
       COPY,    PAST,     KC_LSFT, KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, KC_BSLS,      KC_END, KC_DOWN, KC_PGDN, KC_PPLS, \
       VDLT,    VDRT,     MO(_FN), _______,                                      KC_SPC,                                     _______, KC_CAPS,               KC_INS, _______,  KC_DEL, _______),
    ...
    _______, _______,     _______, _______,                                     _______,                                     _______, _______,                 KC_0, _______, KC_PDOT, _______),
