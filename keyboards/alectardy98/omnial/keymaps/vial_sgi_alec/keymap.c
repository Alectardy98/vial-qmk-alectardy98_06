...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
    _______,  _______,    KC_ESC,           KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,            KC_F9,  KC_F10,  KC_F11,  KC_F12,      KC_F13,  KC_F14,  KC_F15,                                          \
    _______,  _______,    KC_GRV,    KC_1,   KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, _______, KC_BSPC,     KC_PSCR, KC_SLCK, KC_PAUS,  TG(_NUM), KC_PSLS ,KC_PAST, KC_PMNS,    \
    _______,  _______,    KC_TAB,    KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS,               KC_INS, KC_HOME, KC_PGUP,     KC_P7,   KC_P8,   KC_P9, KC_PPLS,    \
    _______,  _______,   KC_CAPS,    KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, _______,  KC_ENT,              _______, _______, _______,     KC_P4,   KC_P5,   KC_P6, _______,    \
    _______,  _______,   KC_LSFT, _______,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, _______,              _______,   KC_UP, _______,     KC_P1,   KC_P2,   KC_P3, KC_PEQL,    \
    _______,  _______,   MO(_FN), _______, _______, KC_LALT, _______,                    KC_SPC,                   KC_RALT, _______, _______, KC_RCTL,              KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0, _______, KC_PDOT, _______),  \
    ...
    _______, _______,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,              _______, _______, _______,   KC_LEFT, _______, KC_RGHT, _______,    \
    ...
    _______, _______,   _______, _______, _______, _______, _______,                   _______,                   _______, _______, _______, _______,              _______, _______, _______,    KC_INS, _______,  KC_DEL, _______),
    ...
    _______, _______,   KC_LCTL,    CTLA,    CTLS,    CTLD,    CTLF, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______,              _______, _______, _______,      VDLT,    QUIT,    VDRT, _______,    \
    _______, _______,   _______, _______,    CTLZ,    CTLX,    CTLC,    CTLV, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______,              _______,    VDUP, _______,   _______,    VDDN, _______, _______,    \
