...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
     KC_ESC,    TASK,     KC_ESC,           KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,            KC_F9,  KC_F10,  KC_F11, KC_F12,      KC_PSCR, KC_SLCK, KC_PAUS,                                          \
       GOGL,     CMD,     KC_GRV,    KC_1,   KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, _______,KC_BSPC,       KC_INS, KC_HOME, KC_PGUP,  TG(_NUM), KC_PSLS ,KC_PAST, KC_PMNS,    \
    DM_PLY1, DM_PLY2,     KC_TAB,    KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS,               KC_DEL,  KC_END, KC_PGDN,      KC_7,    KC_8,    KC_9, KC_PPLS,    \
       SNIP,    EXPL,    KC_CAPS,    KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, _______,  KC_ENT,              KC_MPRV, KC_MPLY, KC_MNXT,      KC_4,    KC_5,    KC_6, _______,    \
       COPY,    PAST,    KC_LSFT, _______,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, MO(_FN),              KC_VOLD,   KC_UP, KC_VOLU,      KC_1,    KC_2,    KC_3, KC_PEQL,    \
       VDLT,    VDRT,    KC_LCTL, MO(_FN),_______, KC_LALT, _______,                    KC_SPC,                   KC_RALT, KC_RGUI, _______, KC_RCTL,              KC_LEFT, KC_DOWN, KC_RGHT,      KC_0, _______, KC_PDOT, _______),   \
