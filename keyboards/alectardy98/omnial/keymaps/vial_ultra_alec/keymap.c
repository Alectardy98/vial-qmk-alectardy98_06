...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
     KC_ESC,    TASK,     KC_ESC,           KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,            KC_F9,  KC_F10,  KC_F11, KC_F12,      KC_PSCR, KC_SLCK, KC_PAUS,                                          \
       GOGL,     CMD,     KC_GRV,    KC_1,   KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, _______,KC_BSPC,       KC_INS, KC_HOME, KC_PGUP,  TG(_NUM), KC_PSLS, KC_PAST, KC_PEQL,    \
    DM_PLY1, DM_PLY2,     KC_TAB,    KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS,               KC_DEL,  KC_END, KC_PGDN,   KC_HOME,   KC_UP, KC_PGUP, KC_PMNS,    \
       SNIP,    EXPL,    KC_CAPS,    KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, _______,  KC_ENT,              KC_MPRV, KC_MPLY, KC_MNXT,   KC_LEFT, _______, KC_RGHT, KC_PPLS,    \
       COPY,    PAST,    KC_LSFT, _______,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, MO(_FN),              KC_VOLD,   KC_UP, KC_VOLU,    KC_END, KC_DOWN, KC_PGDN, KC_PENT,    \
       VDLT,    VDRT,    KC_LCTL, MO(_FN),KC_LALT, _______, _______,                    KC_SPC,                   KC_RALT, _______, KC_RGUI, KC_RCTL,              KC_LEFT, KC_DOWN, KC_RGHT,    KC_INS, _______,  KC_DEL, _______),   \
    ...
    _______, _______,   _______, _______, _______, _______, _______,                   _______,                   _______, _______, _______, _______,              _______, _______, _______,      KC_0, _______, KC_PDOT, _______),
    
    [_FN] = LAYOUT(
    QK_BOOT,   DEBUG,   _______,          _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______,     _______, _______, _______,                                          \
    ...
    _______, _______,   KC_LGUI, _______, _______, _______, _______,                   _______,                   _______, _______, _______, _______,                 VDLT,    VDDN,    VDRT,   _______, _______, _______, _______)
