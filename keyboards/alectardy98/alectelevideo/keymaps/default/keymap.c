...
[0] = LAYOUT(
    ...
    RESET,   KC_1,    KC_2,  KC_3,  KC_4,  KC_5,  KC_6,  KC_7,  KC_8,  KC_9,    KC_0,    KC_MINS, KC_EQL,      KC_BSPC,    KC_GRV,                        KC_F22, KC_F23, KC_F24, KC_PSCR, KC_INS,
    KC_TAB,  KC_Q,    KC_W,  KC_E,  KC_R,  KC_T,  KC_Y,  KC_U,  KC_I,  KC_O,    KC_P,    KC_LBRC, KC_RBRC,     KC_T,       KC_PGUP,             KC_PENT,  KC_P7,  KC_P8,  KC_P9,  KC_PMNS,
    ...
    KC_LGUI, KC_LALT,                            KC_SPC,                               KC_RCTL, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,                          KC_P0,      KC_PSLS, KC_PD
