    ...
    bool num_lock = host_keyboard_led_state().num_lock;       //Puts the keyboard into Num Lock state if host OS initializes in Num Lock state
     ...
     if (record->event.pressed) {             //Code for macros
        ...
        switch(keycode) {
           ...
           //     layer_invert(_NUM);       Blocked for no Numlock
            return false;
            }break;
                //Control Section
            case CTLA:
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
           CUTT,             COPY,             PAST,             TEST,             TEST,             TEST,             TEST,          KC_VOLD,          KC_VOLU, KC_MPLY, \
         KC_ESC,  KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSPC, _______,  KC_DEL,    QUIT, \
        KC_PSTE,  KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS, DM_PLY1,    EXPL,          \
        KC_COPY, KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,  KC_ENT, DM_PLY2,    SNIP,                   \
           VDLT,    VDRT, KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,   KC_UP,  KC_MPRV, KC_MNXT,         \
        KC_LALT, KC_LGUI, KC_LCTL, MO(_FN),                             KC_SPC,                                     KC_BSPC, KC_LEFT, KC_DOWN,  KC_RGHT, KC_MPLY
    ),
    [_FN] = LAYOUT(
        _______,          _______,          _______,          _______,          _______,          _______,          _______,          _______,          _______, _______, \
          RESET, _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_INS, _______, _______, \
        _______, _______,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______, _______, DM_REC1, _______,          \
        _______, KC_LCTL,    CTLA,    CTLS,    CTLD,    CTLF, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, DM_REC2, _______,                   \
        _______, _______, _______,    CTLZ,    CTLX,    CTLC,    CTLV, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,    VDUP, _______, _______,          \
        _______, _______, _______, _______,                            _______,                                     _______,    VDLT,    VDDN,    VDRT, _______
    )
};
