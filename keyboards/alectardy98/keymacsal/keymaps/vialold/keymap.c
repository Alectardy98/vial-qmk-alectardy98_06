...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
           CUTT,             COPY,             PAST,           KC_F21,           KC_F22,           KC_F23,          KC_F24,          KC_VOLD,          KC_VOLU,     QUIT, \
         KC_ESC,  KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSPC, _______,  KC_DEL,    TASK, \
        C(KC_V),  KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS, DM_PLY1,    EXPL,          \
        C(KC_C), KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,  KC_ENT, DM_PLY2,    SNIP,                   \
           VDLT,    VDRT, KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,   KC_UP,  KC_MPRV, KC_MNXT,         \
        KC_LALT, KC_LGUI, MO(_FN), KC_LCTL,                             KC_SPC,                                     KC_BSPC, KC_LEFT, KC_DOWN,  KC_RGHT, KC_MPLY
    ),
    [_FN] = LAYOUT(
        ...
        _______, KC_LCTL, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, DM_REC2, _______,                   \
        _______, _______, _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,    VDUP, _______, _______,          \
        _______, _______, _______, KC_LGUI,                            _______,                                     _______,    VDLT,    VDDN,    VDRT, _______
    )
};
