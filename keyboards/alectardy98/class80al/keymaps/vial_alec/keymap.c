...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        ...
        _______, _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,                         VDUP,
        KC_LGUI, _______, _______,                            _______,                   _______, _______, _______, _______,                VDLT,    VDDN,    VDRT
                   )
    };
