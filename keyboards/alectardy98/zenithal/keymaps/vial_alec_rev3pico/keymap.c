...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
           QUIT,    TASK,    KC_ESC,     KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSPC,  KC_GRV,TG(_NUM), _______, TG(_BEEP),
        DM_PLY1, DM_PLY2,    KC_TAB,     KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC,  KC_ENT, KC_HOME,   KC_UP, KC_PGUP, KC_PMNS,
           SNIP,    EXPL,    KC_LCTL,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, _______,          KC_LEFT, _______, KC_RGHT, KC_PPLS,
           COPY,    PAST,    KC_LSFT, _______,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, KC_BSLS,  KC_END, KC_DOWN, KC_PGDN, KC_PENT,
           VDLT,    VDRT,    KC_LALT, MO(_FN), _______,                   _______,  KC_SPC,                            _______, KC_CAPS, _______,  KC_INS, _______,  KC_DEL, _______, _______
        ),
    ...
    [_FN] = LAYOUT(
        QK_BOOT, _______,    QK_BOOT,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL, _______, _______, _______, MU_TOG,
        DM_REC1, DM_REC2,    _______,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______, _______, _______,    VDUP, _______, MU_MOD,
        ...
        _______, _______,    _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______, _______,    VDDN, _______, _______,
